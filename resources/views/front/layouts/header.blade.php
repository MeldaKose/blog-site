...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('public/front/')}}/assets/favicon.ico"/>
    ...
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="{{route('homepage')}}">
            @if($config->logo==null)
                Start Bootstrap
            @else
                <img src="{{asset('public/uploads/').$config->logo}}">
            @endif
        </a>
...
<!-- Page Header-->
<header class="masthead" style="background-image: url(@yield('bg',asset('public/front/assets/img/home-bg.jpg'))">
