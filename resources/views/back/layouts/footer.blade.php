...
<!-- Page level plugins -->
<script src="{{asset('public/back/')}}/vendor/chart.js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="{{asset('public/back/')}}/js/demo/chart-area-demo.js"></script>
<script src="{{asset('public/back/')}}/js/demo/chart-pie-demo.js"></script>
<!-- Page level plugins -->
